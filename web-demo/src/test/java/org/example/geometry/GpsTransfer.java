...
public class GpsTransfer {
    ...
    public static void main(String[] args) {
        Gps gps = new Gps(39.907270, 116.391213);
        System.out.println(gps);//{39.90727,116.391213}
        Gps gps2 = wgs84_To_Gcj02(gps.lat, gps.lon);
        System.out.println(gps2);//{39.90867122432153,116.39745410656687}
        Gps gps3 = gcj02_To_Wgs84(gps2.lat, gps2.lon);
        System.out.println(gps3);//{39.907267736339556,116.3912105466475}
        Gps gps4 = gcj02_To_Wgs84_exact(gps2.lat, gps2.lon);
        System.out.println(gps4);//{39.90727046748559,116.39121326184032} 相对一次迭代是精确了，但是好像也不是完全还原
    }
